  ...
  <div className="absolute inset-0 flex items-end justify-start text-left p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600">
                NH-6, Durg Bypass, Pushpak Nagar, Near Maruti Suzuki Arena, Bhilai, Chhattisgarh 490020 || <b>Phone</b>: 7566660048
              </p>
              <p className="text-lg text-gray-600">
      ...
      <section className="py-12 bg-gray-50">
        ...
        <div className="absolute inset-0">
          <Image
            src="/media/Bhilai/bhilai-resort-full.jpg" // Replace with your event image path
